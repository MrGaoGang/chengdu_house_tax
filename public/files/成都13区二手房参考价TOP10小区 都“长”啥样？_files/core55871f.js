...
define("pages/mod/bottom_modal.js",["biz_wap/ui/weui_css.js","widget/wx-widget/wx_bottom_modal.css","pages/mod/bottom_modal.html.js","biz_common/tmpl.js","biz_common/dom/class.js","biz_common/dom/event.js","biz_wap/utils/device.js","common/navShadow.js","biz_wap/jsapi/core.js"],function(t){
"use strict";
function e(t,e,o,n){
...
var i=t("pages/mod/bottom_modal.html.js"),s=t("biz_common/tmpl.js"),a=t("biz_common/dom/class.js"),r=t("biz_common/dom/event.js"),l=t("biz_wap/utils/device.js"),c=t("common/navShadow.js"),h=t("biz_wap/jsapi/core.js"),u=100,p="weui-btn_disabled",d={
...
_classCallCheck(this,t),n=_extends({},d,n);
...
o&&!t.pullingUpLock&&t.contentAreaWrp.scrollTop+t.contentAreaWrp.offsetHeight+u>t.contentEle.offsetHeight&&(t.opt.onPullUpLoad&&t.opt.onPullUpLoad(),
t.pullingUpLock=!0);
...
if(this.triggerEl=n||window.event&&window.event.target,this.isAutoFocus=s,!this.getShowStatus()){
e(this.contentArea,"visibility","visible"),a.addClass(this.rootEle,"wx_bottom_modal_show");
var u=document.getElementById("img-content");
u&&u.setAttribute("aria-hidden","true"),this.setAriaHidden(!1),this.rootEle.focus(),
...
}),l.os.ios&&this.opt.sideslip2Hide&&h.invoke("handleDeviceInfo",{
...
setTimeout(function(){
t||(e(i.contentArea,"top",i.opt.top),"right"===i.opt.animationType&&(e(i.contentArea,"-ms-transform","translateX(0)"),
...
value:function(t){
var o=this;
if(t&&e(this.maskNotClick,"visibility","hidden"),this.getShowStatus()){
"bottom"===this.opt.animationType?this.contentArea.style.removeProperty("top"):(this.contentArea.style.removeProperty("-ms-transform"),
this.contentArea.style.removeProperty("transform")),a.removeClass(this.rootEle,"wx_bottom_modal_show");
var i=document.getElementById("img-content");
i&&i.setAttribute("aria-hidden","false"),this.setAriaHidden(!0),this.isAutoFocus&&n(this.triggerEl)&&(console.log("here"),
this.triggerEl.setAttribute("tabindex","0"),this.triggerEl.focus()),this.opt.removeMask||c.hide(),
l.os.ios&&this.opt.sideslip2Hide&&h.invoke("handleDeviceInfo",{
action:"disableInteractivePop",
disable:!1
},function(t){
...
key:"setAriaHidden",
value:function(t){
this.rootEle.setAttribute("aria-hidden",t.toString());
}
}]),t;
}();
return m;
...
function i(){
S&&l.invoke("currentMpInfoShow",{
userName:N.userName,
brandName:N.bizNickName
});
}
function o(){
S&&l.invoke("currentMpInfoHide");
}
function n(){
S&&(t(),f.getScrollTop()>N.showTitleHeight&&i());
}
function r(){
S&&(f.getScrollTop()>N.showTitleHeight?i():o());
}
function a(e){
...
var i=1*(f.getScrollTop()+f.getInnerHeight()),o=_extends({},N.reportData,{
Event:e,
...
function s(){
l.on("topbar:click",function(){
a(3);
});
}
function c(){
var e=f.getScrollTop();
e>=N.showTitleHeight&&!I?(I=!0,S?(l.invoke("currentMpInfoShow",{
userName:N.userName,
brandName:N.bizNickName
}),T||(a(1),T=!0)):document.title=N.bizNickName):e<N.showTitleHeight&&I&&(I=!1,S?l.invoke("currentMpInfoHide"):document.title="");
}
function d(e){
j=e;
}
...
e&&f.getScrollTop()>=N.showTitleHeight&&j&&(t(),i());
});
}
function m(){
...
function p(){
var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];
m(e),t(),s(),u(),v.on(window,"load",function(){
document.title="",c();
}),v.on(window,"scroll",_),window.addEventListener("pageshow",function(e){
e.persisted&&n();
});
}
var l=e("biz_wap/jsapi/core.js"),h=e("biz_wap/utils/mmversion.js"),g=e("common/comm_report.js"),w=e("pages/utils.js"),v=e("biz_common/dom/event.js"),f=e("common/utils.js"),b=e("biz_wap/utils/setMpInfo.js"),N={
showTitleHeight:40,
userName:"",
bizNickName:"",
bizNickNameBackup:"",
...
S="5"===N.itemShowType?h.isIOS&&h.gtVersion("7.0.12",!0)||h.isAndroid&&h.gtVersion("7.0.12",!0):h.isIOS&&h.gtVersion("7.0.10",!0)||h.isAndroid&&h.gtVersion("7.0.12",!0);
var _=w.throttle(c,50),j=!0;
return{
setCurrentMpInfo:t,
showCurrentMpInfo:i,
hideCurrentMpInfo:o,
...
var l=[n,"action=share","action_type="+t,"scene="+(i.source||window.source||e("scene")),"subscene="+e("subscene"),"ascene="+(i.ascene||window.ascene||-1),"req_id="+(i.req_id||window.req_id||""),"vid="+("undefined"!=typeof p?p.join(";"):""),"musicid="+("undefined"!=typeof a?a.join(";"):""),"voiceid="+("undefined"!=typeof d?d.join(";"):""),"weappid="+("undefined"!=typeof w?w.join(";"):""),"item_show_type="+(i.item_show_type||window.item_show_type||0),"ori_status_arr="+_.join(";"),"hit_bizuin="+u.join(";"),"hit_vid_arr="+c.join(";"),"top_stories="+(i.top_stories||0),"content_url="+encodeURIComponent(window.location.href),"channel_session_id="+e("channel_session_id"),"is_pay_subscribe="+window.isPaySubscribe,"is_paid="+window.isPaid,"preview_percent="+window.previewPercent,"fee="+y,"worthy_cnt="+(window.paySubscribeInfo?window.paySubscribeInfo.like_cnt:""),"pay_cnt="+(window.paySubscribeInfo?window.paySubscribeInfo.pay_cnt:""),"album_id="+(window.appmsg_album_info?window.appmsg_album_info.id:""),"album_type="+(window.appmsg_album_info?0:""),"is_cartoon_copyright="+(window.isCartoonCopyright?1:2),"share_source="+i.share_source,"exptype="+window.exptype||"","expsessionid="+window.expsessionid||""];
